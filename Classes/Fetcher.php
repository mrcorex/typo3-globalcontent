...
class Fetcher {
	...
	private function getContentJquery() {
		...
		if (is_null($isInitialized)) {
			$headerData = '<script src="' . \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::siteRelPath("globalcontent") . 'pi1/res/spin.min.js" type="text/javascript"></script>';
			$headerData .= '<script src="' . \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::siteRelPath("globalcontent") . 'pi1/res/jquery.ajax_autoload.js" type="text/javascript"></script>';
