		...
		$conf = $params['fieldConf']['config'];
				...
				<script type="text/javascript">
					function getUrl() {
						...
						var win = window.open("/typo3/tce_db.php?&data[tt_content]['.$params['row']['uid'].'][tx_globalcontent_orgurl]="+escape(url)+"&vC='.$GLOBALS['BE_USER']->veriCode().'&prErr=1'.t3lib_BEfunc::getUrlToken('tceAction').'",\'popUpID'.t3lib_div::shortMD5(time()).'\',\'width=1,height=1\');
